...
**New Features**
* A `sndio` backend gives Shairport Sync fully native synchronised output on OpenBSD and FreeBSD, thanks to the work of [Tobias Kortkamp (t6)](https://github.com/t6).
